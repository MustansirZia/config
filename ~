...
alias prod="aws-vault exec prod --no-session --duration=15m --"
alias qa="aws-vault exec qa --no-session --duration=15m --"
alias tst="aws-vault exec test --no-session --duration=15m --"
